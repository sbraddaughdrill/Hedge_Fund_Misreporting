...
univariate_vars_continuous <- c(univariate_vars_continuous_fund,univariate_vars_continuous_text)
...
output_directory_univariate_manual <- paste(output_directory,"univariate_inverse_manual","\\",sep="")
